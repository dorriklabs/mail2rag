...
TEST_EMAILS = [
    ...
    # --- NOUVEAUX CAS : AMBIGUS ---
    {
        "id": "AMBIGUOUS_1",
        "type": "Support (RAG)",
        "subject": "Question sur les abris",
        "sender": "citoyen.urba@dsiatlantic.com",
        "body": "Je veux installer un abri. Quelles sont les règles ?",
    },
    {
        "id": "AMBIGUOUS_2",
        "type": "Support (RAG)",
        "subject": "Démarche passeport ou carte d'identité",
        "sender": "citoyen.etatcivil@dsiatlantic.com",
        "body": "Je dois refaire mes papiers, comment faire ?",
    },
    {
        "id": "AMBIGUOUS_3",
        "type": "Support (RAG)",
        "subject": "Ramassage",
        "sender": "citoyen.voirie@dsiatlantic.com",
        "body": "C'est quand le ramassage ?",
    },
    {
        "id": "AMBIGUOUS_4",
        "type": "Support (RAG)",
        "subject": "Inscription",
        "sender": "parent@dsiatlantic.com",
        "body": "Comment inscrire mon enfant ?",
    },
    {
        "id": "AMBIGUOUS_5",
        "type": "Support (RAG)",
        ...
        "body": "J'ai besoin d'une aide financière.",
    },
    
    # --- NOUVEAUX CAS : HORS-SUJET ---
    {
        "id": "OOD_1",
        "type": "Support (RAG)",
    ...
    # --- NOUVEAUX CAS : FAUTES / LANGAGE FAMILIER ---
    {
        ...
        "subject": "paspor",
        "sender": "citoyen@dsiatlantic.com",
        "body": "bonjour je voudrai fer un paspor c koi la demarch svp",
    },
    {
        "id": "TYPO_2",
        "type": "Support (RAG)",
        "subject": "bruit",
        "sender": "citoyen@dsiatlantic.com",
        "body": "le bar a coté fé tro de brui le soir on pe plu dormir",
    },
    {
        "id": "TYPO_3",
        "type": "Support (RAG)",
        "subject": "cantin",
        "sender": "parent@dsiatlantic.com",
        "body": "c koi lé papié pour la cantin ?",
    },
    {
        "id": "TYPO_4",
        "type": "Support (RAG)",
        "subject": "pisin",
        "sender": "citoyen@dsiatlantic.com",
        "body": "jve fer une pisin dan mon jardin fo un permi ?",
    },
    {
        "id": "TYPO_5",
        "type": "Support (RAG)",
        "subject": "encombran",
        "sender": "citoyen@dsiatlantic.com",
        "body": "kan pass le camion pour les gro dechet ?",
    },
    ...
    # --- NOUVEAUX CAS : ANGLAIS ---
    {
        ...
        "type": "Support (RAG)",
        "subject": "Garden shed",
        "sender": "expat@dsiatlantic.com",
        "body": "Hello, I want to build a garden shed. What are the rules?",
    },
    {
        "id": "EN_2",
        "type": "Support (RAG)",
        ...
        "sender": "expat@dsiatlantic.com",
        "body": "I need to renew my passport urgently, how to book an appointment?",
    },
    {
        "id": "EN_3",
        "type": "Support (RAG)",
        ...
        "sender": "expat@dsiatlantic.com",
        "body": "The bar downstairs plays very loud music at night. Please help.",
    },
    {
        "id": "EN_4",
        "type": "Support (RAG)",
        ...
        "sender": "expat@dsiatlantic.com",
        "body": "How can I register my child for the school canteen?",
    },
    {
        "id": "EN_5",
        "type": "Support (RAG)",
        "subject": "Bulky waste",
        "sender": "expat@dsiatlantic.com",
        "body": "When is the bulky waste collection in my area?",
    },
    ...
    # --- NOUVEAUX CAS : CONVERSATIONNELS / SUITE ---
    {
        "id": "CONV_1",
        "type": "Support (RAG)",
        "subject": "Re: Inscription cantine scolaire",
        "sender": "parent.eleve@dsiatlantic.com",
        "body": "Est-ce qu'il faut aussi un justificatif de domicile pour la crèche ?",
    },
    {
        "id": "CONV_2",
        "type": "Support (RAG)",
        "subject": "Re: Renouvellement passeport urgent",
        "sender": "citoyen.etatcivil@dsiatlantic.com",
        "body": "D'accord, et pour l'acte de naissance, c'est aussi sur le portail citoyen ?",
    },
    {
        "id": "CONV_3",
        "type": "Support (RAG)",
        "subject": "Re: Nid de poule dangereux",
        "sender": "citoyen.voirie@dsiatlantic.com",
        "body": "Ils interviendront sous 48h ? Parfait.",
    },
    {
        "id": "CONV_4",
        "type": "Support (RAG)",
        "subject": "Re: Réservation salle des fêtes",
        "sender": "president.asso@dsiatlantic.com",
        "body": "Il faut s'y prendre un mois à l'avance ? C'est noté.",
    },
    {
        "id": "CONV_5",
        "type": "Support (RAG)",
